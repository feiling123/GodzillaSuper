...
public class CSharpGzip implements Cryption {
    ...
    public static byte[] code(byte[] data, byte[] key, boolean isEncode) throws Exception {
        ...
        byte[] processData = data;
        if (!isEncode && functions.isGzipStream(data)) {
            processData = gzipDecompress(data);
        }
    ...
    public byte[] generate(String password, String secretKey) {
        return Generate.GenerateShellLoder("gzip.bin", this.suffix, password, secretKey);
    }
}
