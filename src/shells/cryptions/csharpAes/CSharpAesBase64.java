...
@CryptionAnnotation(
    Name = "CSHARP_AES_BASE64",
    payloadName = "CSharpDynamicPayload"
)
public class CSharpAesBase64 implements Cryption {
    ...
    public byte[] generate(String password, String secretKey) {
        return Generate.GenerateShellLoder("base64.bin", this.suffix, password, secretKey);
    }
}
