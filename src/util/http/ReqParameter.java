...
public class ReqParameter extends Parameter {
    ...
    public static ReqParameter createParameter() {
        return new ReqParameter();
    }

    public static ReqParameter createInvokeMethodReqParameter() {
        return (ReqParameter)createParameter().add("invokeMethod", "true");
    }
}
